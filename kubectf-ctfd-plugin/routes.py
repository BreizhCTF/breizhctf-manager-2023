...
from .lib import error, get_deployment, create_deployment, extend_deployment, reset_deployment, terminate_deployment
...
def get_challenge(challenge):
    ...
    try:
        if request.method == 'GET':
            ...
            elif request.json.get('action') == 'reset':
                return reset_deployment(host, secret, owner_id, False, challenge)
